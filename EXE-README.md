...
1. Introduction
  ...
  Visual_Phaser.V1.0.exe is a specialized bioinformatics application designed for
...
2. System Requirements & Installation
  ...
  Project Structure
   - Visual_Phaser.V1.0.exe: The main execution engine.
  ...
  "PixelChromosomeView" (PCV).
   - Naming Convention: Files must contain the testing company followed by the person's
     ...
     - .csv files can be converted to .txt files with
       converter exe/ancestry_csv_to_tab_converter_V1.exe or
       converter exe/non_ancestry_csv_to_tab_converter_V1.exe.
