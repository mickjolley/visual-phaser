...
TOOLTIPS = {
    ...
    'SIBLINGS': 'Comma-separated names to compare.',
    ...
    'COUSINS': 'Comma-separated names to compare against siblings in an existing workbook.',
...
class VPConfigBoaFrame(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.siblingsLabel = wx.StaticText(id=wx.ID_ANY,
              ...
              parent=self.filesPanel, pos=wx.Point(8, 8), size=wx.Size(330, 17), style=0)
        ...
        self.siblingsText.SetToolTip("Use exact names from the VCF header or file names.")
        ...
        self.cousinsText = wx.TextCtrl(id=wxID_VPCONFIGBOAFRAMECOUSINSTEXT,
              ...
              size=wx.Size(715, 21), style=0, value='')
        self.cousinsText.SetToolTip("Use exact names from the same VCF header or file names.")
    ...
    def _update_config_lines(self, lines):
        ...
        while index < total:
            ...
            # Remove stale continuation lines from older multi-line values.
            index += 1
